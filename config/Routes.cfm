<cfscript>
	...
	addRoute( pattern="add", handler="main", action="add");
	addRoute( pattern="complete", handler="main", action="complete");
	addRoute( pattern="completed", handler="main", action="completed");
